  ...
  class Cube {
    ...
    show() {
      ...
      for (let i = 0; i < facePositions.length; i++) {
        ...
        p5.fill(
          colors[this.faces[0][i]][0],
          colors[this.faces[0][i]][1],
          colors[this.faces[0][i]][2],
        );
      ...
      for (let i = 0; i < facePositions.length; i++) {
        ...
        let y = this.s * facePosition[1];
        p5.fill(
          colors[this.faces[1][i]][0],
          colors[this.faces[1][i]][1],
          colors[this.faces[1][i]][2],
        );
...
new p5(
  (p) => RUBIKS_CUBE(p, document.querySelector("#sketch") || null),
